...
# This module contains all the functions/"meat" of the game.
# A demonstration of refactorisation (code optimization)
...
def update_bullets(ai_settings, screen, stats, sb, ship, aliens, bullets):
    '''Update position of bullets and get rid of old bullts.'''
...
def check_bullet_alien_collisions(ai_settings, screen, stats, sb, ship, aliens, bullets):
    ...
    if len(aliens) == 0:
        # If the entire fleet is gone, start new level.
        bullets.empty()
